...
const formSchema = z.object({
  ...
  industryDataId: z.array(z.string()).min(1, "Please select sub industry"),
});
...
const Categories = () => {
  ...
  useEffect(() => {
    dispatch(getAllSubSubIndustryWithPagination({ page, size: rowsPerPage }));
      ...
      dispatch(createSubsubIndustry(values))
        .then((resp) => {
          if (resp.meta.requestStatus === "fulfilled") {
            addToast({
              title: "Sub sub industry created successfully !.",
              color: "success",
            });
            dispatch(
