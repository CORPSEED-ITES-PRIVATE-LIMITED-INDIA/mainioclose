                ...
                <Flex vertical>
                  ...
                  <Flex vertical>
                    ...
                    <Flex vertical>
                      <Flex>
                        {details?.primaryCity && (
                          <Text>{details?.primaryCity?.name},</Text>
                        )}
                        {details?.primaryState && (
                          <Text>{details?.primaryState?.name},</Text>
                        )}
                        {details?.primaryCountry && (
                          <Text>{details?.primaryCountry?.name}</Text>
                        )}
                      </Flex>
                    </Flex>
                  ...
                  {invoice && (
                    <>
                      ...
                      <Flex vertical gap={6}>
                        ...
                        <Text type="secondary">
                          <span strong>IMPS/RTGS/NEFT :</span>
                        </Text>
                        <Text type="secondary">
                          Account number : 10052624515 || IFSC code :
                          IDFB0021331 || Beneficiary Name : Corpseed ITES
                          Private Limited || Bank name : IDFC First bank ,Noida
                          ,Sector 63 Branch
                        </Text>
                        <Text type="secondary">
                          <span strong>Direct pay </span> :
                          https://www.corpseed.com/payment ||{" "}
                          <span strong>Pay via UPI</span> :CORPSEEDV.09@cmsifdc
                        </Text>
                      </Flex>
                    </>
                  )}
