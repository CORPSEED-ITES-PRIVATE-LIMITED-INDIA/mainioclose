...
import { getAllLeadUser, getAutomationLeads } from "../../../Toolkit/Slices/LeadSlice";
...
const AutomationLeads = () => {
  ...
  const data = useSelector((state) => state.leads.automationReportList);
  ...
  const columns = [
    ...
    {
      dataIndex: "statusDealWon",
      title: "Deal won status",
    },
    {
  ...
  return (
    <div className="lead-module small-box-padding">
      <div className="create-user-box">
        <MainHeading data={`Automation status list`} />
      </div>
