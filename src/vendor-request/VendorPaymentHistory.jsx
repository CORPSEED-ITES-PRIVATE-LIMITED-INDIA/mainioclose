...
const VendorPaymentHistory = () => {
  ...
  const data = useSelector((state) => state.vendors.vendorPaymentHistory);
  const count = useSelector(
    (state) => state.vendors.vendorPaymentHistory?.length,
  );
  ...
  useEffect(() => {
    dispatch(getVendorPaymentHistory(paymentId));
  }, [dispatch]);
