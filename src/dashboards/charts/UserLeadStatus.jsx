...
import { getAllUserLeadDataMonthWise } from "../../toolkit/slices/dashboardSlice";
...
const UserLeadStatus = () => {
  ...
  const leadsData = useSelector((state) => state.dashboard.userLeadDataMonthWiseList);
  ...
  useEffect(() => {
    dispatch(getAllUserLeadDataMonthWise(leadDataFilter));
