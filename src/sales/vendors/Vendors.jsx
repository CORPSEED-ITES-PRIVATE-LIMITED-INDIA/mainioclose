...
const columns = [
  { name: "ID", uid: "id" },
  { name: "CONTACT PERSON NAME", uid: "contactPersonName", sortable: true },
  { name: "CONTACT COMPANY NAME", uid: "clientCompanyName" },
  { name: "CONTACT DETAIL", uid: "contactNumber" },
...
const formSchema = z.object({
  ...
  salesAttachmentReferencePath: z.string().min(1, "please upload the document"),
