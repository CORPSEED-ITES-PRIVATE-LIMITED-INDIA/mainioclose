...
const FieldShell = ({
  ...
  <div className="w-full">
    ...
    {isInvalid && errorMessage && (
      <div className="mt-1 text-xs font-medium text-red-500 dark:text-red-400">
        {errorMessage}
      </div>
    )}
  </div>
...
const Input = ({
  ...
  >
    <AntInput
      ...
      className="h-10 rounded-lg border-slate-300 bg-white text-slate-900 placeholder:text-slate-400 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500"
    />
  </FieldShell>
);
  ...
  return (
    ...
    >
      <AntSelect
        ...
        popupClassName="dark-ant-select-dropdown"
        className="w-full dark-ant-select"
        style={{ height: 40 }}
        onChange={(value) => {
...
const DatePicker = ({
  ...
  >
    <AntDatePicker
      ...
      maxDate={maxValue}
      format="YYYY-MM-DD"
      popupClassName="dark-ant-picker-dropdown"
      className="h-10 w-full rounded-lg border-slate-300 bg-white text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
      status={isInvalid ? "error" : ""}
    ...
    <Modal
      ...
      title={
        <div className="flex items-center justify-between">
          ...
          <div className="hidden rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-xs font-semibold text-blue-700 dark:border-blue-800 dark:bg-blue-950/60 dark:text-blue-300 md:block">
            Company Master Form
          </div>
        </div>
      }
    >
      <div className="bg-slate-50 px-5 py-5 dark:bg-slate-950">
        <CompanyAndUnitsForm
  ...
  return (
    <>
      ...
      >
        <Card
          ...
          title={
            <div className="flex items-center justify-between gap-3">
              <div>
                <h2 className="m-0 text-base font-bold text-slate-900 dark:text-slate-100">
                  Company Details
                </h2>
              ...
              <span className="rounded-full border border-slate-200 bg-white px-3 py-1 text-[11px] font-semibold text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                Step 1
              </span>
            </div>
          }
          ...
          <div className="space-y-5">
            {fields.map((item, index) => {
              ...
              return (
                <div
                  key={item.id}
                  className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4 shadow-sm dark:border-slate-700 dark:bg-slate-950/80"
                >
                  <div className="mb-4 flex items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-900">
                    <div>
                      <p className="m-0 text-sm font-bold text-slate-900 dark:text-slate-100">
                        Unit #{index + 1}
                      </p>
                      <p className="mt-0.5 mb-0 text-[11px] font-medium text-slate-500 dark:text-slate-400">
        ...
        <div className="sticky bottom-0 z-20 flex items-center justify-end gap-3 border-t border-slate-200 bg-white/95 px-5 py-4 shadow-[0_-8px_24px_rgba(0,0,0,0.04)] backdrop-blur dark:border-slate-700 dark:bg-slate-900/95">
          <ButtonWrapper
            htmlType="button"
            variant="bordered"
